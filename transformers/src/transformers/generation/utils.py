...
class GenerationMixin:
    ...
    def generate(
        ...
        **kwargs,
        ...
        Generates sequences of token ids for models with a language modeling head.  The new method **Improved Adaptive Contrastive Search**
        is integrated into this function. You can use the "iACS" method in model.generate() for different tasks.
